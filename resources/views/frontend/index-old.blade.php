                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="text-center">
                                                    ...
                                                    <p>We are happy to announce that the Golden Jubilee Celebration of The Department of Philosophy, University of Chittagong will be held on 28 October, 2023 Saturday.
                                        ...
                                        <div class="row">
                                            <div class="col-sm-12 col-md-12 col-lg-12">
                                                <div class="reg-div text-center ">
                                                    ...
                                                    <p> 
                                                        <a href="{{route('registration')}}" class="btn btn-outline-danger">Register With Event Online</a>
                                                    </p>

                                                    <p> 
                                                        <a href="{{route('register')}}" class="btn btn-outline-danger">Register Without Event Online</a>
                                                    </p>
                                                </div>
                                            </div>
