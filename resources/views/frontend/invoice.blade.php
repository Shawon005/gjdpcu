                                            ...
                                            <div class="box-reg">
                                                <div class="row">
                                                    ...
                                                    <div class="col-sm-12 col-md-12 col-lg-6 my-4" style="line-height: 183%;">
                                                        ...
                                                        <p><b>Batch: </b>{{ordinal($user->batch)}}</p>
                                                ...
                                                <table class="table table-bordered  table-hover inv-table">
                                                    <thead>
                                                        <tr>
                                                            <th>No</th>
                                                ...
                                                <div class="print-btn text-end">
                                                    ...
                                                    @else
                                                    <a type="button" href="{{route('pdf_id',$user->id)}}"class="btn btn-danger"><i class="fa fa-print" aria-hidden="true"></i> Print</a>  
                                                    @endif
                                                    @else
