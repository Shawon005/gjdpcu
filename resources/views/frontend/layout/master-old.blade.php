                        ...
                        <div class="row">
                                                ...
                                                <li class="nav-item dropdown">
                                                        <a class="nav-link dropdown-toggle" href="#" id="navbarDarkDropdownMenuLink" role="button" data-bs-toggle="dropdown" aria-expanded="false">
                                                            ...
                                                            <ul class="dropdown-menu dropdown-menu-dark" aria-labelledby="navbarDarkDropdownMenuLink">
                                                                @if(table('registration','id',session('user'),'payment_type')=='pending')
                                                                <li><a class="dropdown-item" href="{{route('event')}}">Add Participant</a></li>
                                                                @endif
                            ...
                            <div class="col-sm-12 col-md-12 col-lg-12">
                                <div class="footer-body">
                                    ...
                                    <div class="row">
                                    	<div class="col-md-12">
                                    		<p class="text-center ms-3" style="font-size: 16px;font-weight: 600;">&copy; All right reserved Department of Philosophy.</p>
                                    		<hr>
                                    	</div>
                                    </div>
                                    <div class="row">
